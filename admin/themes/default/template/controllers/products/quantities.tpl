	...
	<div id="product-quantities" class="panel product-tab">
		...
		{else}
			...
			<div class="form-group">
				...
				<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="initial_quantity" type="default"}</span></div>
					<span class="label-tooltip" data-toggle="tooltip" title="{l s='Initial Quantity'}">
					{l s='Initial Quantity'}
				</label>
				<div class="input-group col-lg-2">
					<input type="hidden" id="initial_quantity" name="initial_quantity" value="{$product->initial_quantity}"/>
