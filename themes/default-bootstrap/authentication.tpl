	...
	<div class="row">
		<div class="col-xs-12 col-sm-6" style="color:white;background-color:#0071BC;border-top-right-radius:70px ; padding-bottom: 0px;">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box" style="color:white;background-color:#0071BC;border:none; border-top-right-radius:70px; padding-bottom: 0px; ">
				<h3 class="page-subheading" style="color:white;background-color:#0071BC" >{l s='Create an account'}</h3>
				<div class="form_content clearfix">
					<p>{l s='Please enter your email address to create an account.'}</p>
					<div class="alert alert-danger" id="create_account_error" style="display:none"></div>
					<div class="form-group">
						<label for="email_create" style="color:white;background-color:#0071BC">
						{l s='Email address'}</label>
					...
					<div class="submit" >
						...
						<button class="btn btn-default button button-medium exclusive" type="submit" id="SubmitCreate" name="SubmitCreate" style="background-color:#ED1C24;color:white">
							<span>
				...
				{foreach from=$genders key=k item=gender}
					<div class="radio-inline">
						<label for="id_gender{$gender->id}" class="top" style = "color:white">
							<input style = "color:white" type="radio" name="id_gender" id="id_gender{$gender->id}" value="{$gender->id}" {if isset($smarty.post.id_gender) && $smarty.post.id_gender == $gender->id}checked="checked"{/if} />
						{$gender->name}
						</label>
					</div>
				{/foreach}
