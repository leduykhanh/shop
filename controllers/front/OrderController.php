		...
		switch ((int)$this->step)
		{
			...
			case 1:
				...
				if (Tools::getValue('multi-shipping') == 1)
				{
					...
					if($this->old) $this->setTemplate(_PS_THEME_DIR_.'order-address-multishipping.tpl');
					else $this->setTemplate(_PS_THEME_DIR_.'lee-purchase.tpl');
				}
				else {
					if(!$this->old)
						$this->_assignSummaryInformations();
					if ($this->old) $this->setTemplate(_PS_THEME_DIR_.'order-address.tpl');
					else $this->setTemplate(_PS_THEME_DIR_.'lee-purchase.tpl');
				}
			break;
			...
			case 2:
				...
				if(!$this->old)
						$this->_assignSummaryInformations();
				if($this->old) $this->setTemplate(_PS_THEME_DIR_.'order-carrier.tpl');
				else $this->setTemplate(_PS_THEME_DIR_.'lee-purchase.tpl');
			break;
			...
			case 3:
				...
				$this->_assignSummaryInformations();
				if($this->old) $this->setTemplate(_PS_THEME_DIR_.'order-payment.tpl');
				else $this->setTemplate(_PS_THEME_DIR_.'lee-purchase.tpl');
			break;
